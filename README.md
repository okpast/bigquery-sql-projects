...
| [Email Engagement Retention Analysis](email_engagement_retention/) | Monthly registration cohorts, send- and open-based email retention | `data-analytics-mate.DA` | — |
